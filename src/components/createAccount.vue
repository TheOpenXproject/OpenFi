            ...
            <template v-slot:default="dialog">
              <template>
                <v-stepper v-model="e1">
                  <v-stepper-header dark class="green lighten-1">
                  ...
                  <v-stepper-items>
                    <v-stepper-content step="1">
                      ...
                      >
                        <v-container>
                          <h2>Intro</h2>
                          <br />
                          Hi, you will be guided in deploying your own contracts
                          that will help you manage your Wallets, Tokens,
                          Transactions on Harmony. Please make sure you have a
                          funded wallet. This site Currently supports the Ledger
                          nano S and harmony One Wallet.
                          <br />
                          You will need to publish a total of 4 contracts in
                          order to use this Service. <br /><br />
                          <b>#1 The Manager Contract:</b> This Contract helps
                          you manage your 3 other contracts you are going to
                          deploy.<br /><br />
                          <b>#2 The Wallet Contract:</b> This will help you
                          manage your multiple wallets that you will come to
                          have on Harmony.<br /><br />
                          <b>#3 The Budget Contract:</b> This one will help you
                          manage where your tokens are going and will serve as a
                          support for your banking applications<br />
                          <b>#4 The Token Contract:</b> as you may have guessed,
                          This will help you manage tokens you Create, Buy,
                          Sell<br /><br /><br /><br />
                        </v-container>
                      </v-card>
                      ...
                      <v-btn class="float-right" color="success" @click="e1++">
                        Continue
                      </v-btn>
                    </v-stepper-content>
                    ...
                    <v-stepper-content id="bridge" step="2">
                      <v-card flat class="" color="white" height="auto">
                        ...
                        means you will loose your saved data (for now) And wont
                        get back the Gas you spent.<br />
                        Use common Sense :<br /><br />
                        <br />If you save data on the blockchain, keep in mind
                        that it is accessible to anyone who has enough will
                        power, though the architecture of this app greatens the
                        difficulty <b>Do not</b> send tokens to your contracts
                        (for now) <br /><br />
                        <b
                          >Always check what you are signing. (this site doesnt
                          ask for funds. you only pay gas fees. dont sign if
                          VALUE > 0)</b
                        ><br /><br />
                      </v-card>
                    ...
                    <v-stepper-content step="3">
                      <v-card class="mb-12" color="white" min-height="400"
                        ><v-container class="text-center" fluid>
                          <h5>
                            Choose which Wallet to use. if you dont have any of
                            the wallets mentionned below, please get one or
                    ...
                    <v-stepper-content step="4">
                      ...
                      >
                          ...
                          <center>
                            ...
                            >
                              <v-container class="">
                                <v-row>
                                  <v-col> status :</v-col>
                                  <v-col>{{ TX.transaction.txStatus }}</v-col>
                                </v-row>
                                <v-row>
                        ...
                        <v-btn class="blue lighten-1" @click="createManager()">
                          Deploy
                        </v-btn>
                      </v-card>
                      <v-btn @click="e1--" text>
